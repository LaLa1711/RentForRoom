...
{
    public class HChiTietPhongsController : Controller
    {
        private QLNhaTroEntities db = new QLNhaTroEntities();

        // GET: Admin/HChiTietPhongs
        ...
        public ActionResult Index()
        {
            ...
            int maTaiKhoan = Convert.ToInt32(Session["MaTaiKhoan"]); // Chuyển đổi Session về kiểu int
            var chiTietPhongs = db.tbChiTietPhongs
                                  .Where(p => p.MaTaiKhoan == maTaiKhoan) // Lọc các bản ghi phù hợp
                                  .ToList();

            return View(chiTietPhongs); // Truyền dữ liệu đã lọc sang View
        ...
        // GET: Admin/HChiTietPhongs/Create
        ...
        public ActionResult Create(tbChiTietPhong tbChi, IEnumerable<HttpPostedFileBase> RoomImages)
        {
            ...
            { 
                ...
                if (RoomImages != null && RoomImages.Any())
                {
                    ...
                    return Redirect("/Admin/HChiTietPhongs");
            }
            catch
            {
                return View(tbChi);
        ...
        // GET: Admin/HChiTietPhongs/Edit/5
        public ActionResult Edit(int? id)
        {
            ...
            var images = db.tbAlbums.Where(a => a.IDPhong == id).ToList();
            ViewBag.RoomImages = images;
        ...
        // GET: Admin/HChiTietPhongs/Delete/5
        ...
        // POST: Admin/HChiTietPhongs/Delete/5
