...
{
    public class ATaiKhoanController : Controller
    {
        // GET: Admin/ATaiKhoan
        ...
        public ActionResult Index(ThongTinCaNhanModels model, HttpPostedFileBase Editfile)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    return RedirectToAction("Index", "ATaiKhoan", new { area = "Admin" });
                }
                else
                {
        ...
        public ActionResult UpdateUserProfile(ThongTinCaNhanModels model, string OldMatKhau, string NewMatKhau, string ConfirmNewMatKhau)
        {
            try
            {
                ...
                return RedirectToAction("UpdateUserProfile", "ATaiKhoan", new { area = "Admin" });
            }
            catch (Exception ex)
            {
